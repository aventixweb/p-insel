...
(function () {
  ...
  const T = {
    de: {
      ...
      'k.about.p4':      'Ich falle weniger durch Zurückhaltung auf, verteile gute Laune und habe eine ausgeprägte Schwäche für <strong style="color:var(--text);">Dinosaurier</strong>.<br>Zwischen Lachen und Deep Talk bewege ich mich dabei erstaunlich mühelos.',
      ...
      'faq.a8.li4': 'Verzichte vor deinem Termin auf <strong>blutverdünnende und immunschwächende Medikamente oder Lebensmittel</strong> (z.B. Aspirin / Alkohol), <strong>Betäubungsalben</strong> und <strong>Sonnenbaden</strong>',
      ...
      'p.cta.title':       'BEREIT FÜR<br>DEIN NÄCHSTES<br><span>TATTOO?</span>',
    ...
    en: {
      ...
      'p.cta.title':       'READY FOR<br>YOUR NEXT<br><span>TATTOO?</span>',
