...
(function () {
  ...
  const T = {
    de: {
      ...
      'kon.body.wade':    'Wade',
      'kon.upload.guide': '• <strong>Wichtig!</strong> Foto von der Körperstelle, wo das Tattoo platziert werden soll<br>• Foto vom Wunschmotiv (Tier / Actionfigur / Portraitfotos etc.)<br>• Beispielfoto für die Stilrichtung<br>• Foto vom Wannado',
      'kon.upload.text':  'Bilder hier ablegen oder <span style="color:var(--accent)">klicken</span>',
      'kon.upload.hint':  'JPG, PNG, HEIC — max. 5 Bilder, je max. 5 MB',
    ...
    en: {
      ...
      'kon.body.wade':    'Calf',
      'kon.upload.guide': '• <strong>Important!</strong> Photo of the body area where the tattoo will go<br>• Photo of your desired motif (animal / action figure / portrait photos etc.)<br>• Example photo for the style direction<br>• Photo of your wannado',
      'kon.upload.text':  'Drop images here or <span style="color:var(--accent)">click</span>',
      'kon.upload.hint':  'JPG, PNG, HEIC — max. 5 images, 5 MB each',
